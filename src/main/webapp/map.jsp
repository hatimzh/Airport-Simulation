  ...
  var cities = [
    {
      ...
      destinations : ['newyork','oslo','paris','lisbon']
    },
     {
      id: "athens",
      title: "Athens",
      ...
      destinations : ['rabat','london']
        ...
        destinations : ['newyork','madrid','paris','tunis']
...
function dijkstra(graph, start, destination) {
  ...
  return {
    ...
    //fin dijkstra function.
      ...
      var graph = {
	  london: {
		    newyork: getDistanceFromLatLonInKm("london", "newyork"),
		  ...
		  newyork: {
		    london: getDistanceFromLatLonInKm("newyork", "london"),
		    rabat: getDistanceFromLatLonInKm("newyork", "rabat"),
		  },
		  oslo: {
		  ...
		  rabat: {
		    ...
		    newyork: getDistanceFromLatLonInKm("rabat", "newyork"),
